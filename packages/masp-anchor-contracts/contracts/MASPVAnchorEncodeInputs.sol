...
library MASPVAnchorEncodeInputs {
	...
	function _encodeInputs2(
		...
		if (_maxEdges == 1) {
			...
			inputs[11] = uint256(_aux.validFeeAssetIDs[0]);
			inputs[12] = uint256(_aux.validFeeAssetIDs[1]);
			inputs[13] = uint256(_aux.validFeeAssetIDs[2]);
			inputs[14] = uint256(_aux.validFeeAssetIDs[3]);
			inputs[15] = uint256(_aux.validFeeAssetIDs[4]);
			inputs[16] = uint256(_aux.validFeeAssetIDs[5]);
			inputs[17] = uint256(_aux.validFeeAssetIDs[6]);
			inputs[18] = uint256(_aux.validFeeAssetIDs[7]);
			inputs[19] = uint256(_aux.validFeeAssetIDs[8]);
			inputs[20] = uint256(_aux.validFeeAssetIDs[9]);
			...
			inputs[17] = uint256(_aux.validFeeAssetIDs[0]);
			inputs[18] = uint256(_aux.validFeeAssetIDs[1]);
			inputs[19] = uint256(_aux.validFeeAssetIDs[2]);
			inputs[20] = uint256(_aux.validFeeAssetIDs[3]);
			inputs[21] = uint256(_aux.validFeeAssetIDs[4]);
			inputs[22] = uint256(_aux.validFeeAssetIDs[5]);
			inputs[23] = uint256(_aux.validFeeAssetIDs[6]);
			inputs[24] = uint256(_aux.validFeeAssetIDs[7]);
			inputs[25] = uint256(_aux.validFeeAssetIDs[8]);
			inputs[26] = uint256(_aux.validFeeAssetIDs[9]);
	...
	function _encodeInputs16(
		...
		if (_maxEdges == 1) {
			...
			inputs[25] = uint256(_aux.validFeeAssetIDs[0]);
			inputs[26] = uint256(_aux.validFeeAssetIDs[1]);
			inputs[27] = uint256(_aux.validFeeAssetIDs[2]);
			inputs[28] = uint256(_aux.validFeeAssetIDs[3]);
			inputs[29] = uint256(_aux.validFeeAssetIDs[4]);
			inputs[30] = uint256(_aux.validFeeAssetIDs[5]);
			inputs[31] = uint256(_aux.validFeeAssetIDs[6]);
			inputs[32] = uint256(_aux.validFeeAssetIDs[7]);
			inputs[33] = uint256(_aux.validFeeAssetIDs[8]);
			inputs[34] = uint256(_aux.validFeeAssetIDs[9]);
			...
			inputs[31] = uint256(_aux.validFeeAssetIDs[0]);
			inputs[32] = uint256(_aux.validFeeAssetIDs[1]);
			inputs[33] = uint256(_aux.validFeeAssetIDs[2]);
			inputs[34] = uint256(_aux.validFeeAssetIDs[3]);
			inputs[35] = uint256(_aux.validFeeAssetIDs[4]);
			inputs[36] = uint256(_aux.validFeeAssetIDs[5]);
			inputs[37] = uint256(_aux.validFeeAssetIDs[6]);
			inputs[38] = uint256(_aux.validFeeAssetIDs[7]);
			inputs[39] = uint256(_aux.validFeeAssetIDs[8]);
			inputs[40] = uint256(_aux.validFeeAssetIDs[9]);
